            ...
            <div class="col-md-6">
                ...
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Country</label>
                        <div class="col-sm-10">
                            <select class="form-control gds-cr gds-countryflag" country-data-region-id="gds-cr-three" data-language="en"></select>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="col-md-6">
                <form class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Country</label>
                        <div class="col-sm-10">
                            <select class="form-control gds-cr" country-data-region-id="gds-cr-two" data-language="en" country-data-default-value="US"></select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="gds-cr-two" class="col-sm-2 control-label">Region</label>
                        <div class="col-sm-10">
                            <select class="form-control" id="gds-cr-two" region-data-default-value="California"></select>
                        </div>
                    </div>
                </form>
                <br/>
